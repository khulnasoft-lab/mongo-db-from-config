...
setup(
    ...
    version=get_version("src/mongo_db_from_config/_version.py"),
    ...
    project_urls={
        "Source": "https://github.com/khulnasoft-lab/mongo-db-from-config",
        "Tracker": "https://github.com/khulnasoft-lab/mongo-db-from-config/issues",
    },
    # Author details
